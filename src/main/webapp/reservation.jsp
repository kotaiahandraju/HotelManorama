    ...
    <animateTransform attributeType="xml" attributeName="transform"
			...
			<div>
				<form action="reservation.html" method="post"
					class="form-horizontal" role="form" id="ReservationAddForm"
							...
							<div class="checkin-checkout">
								<div class="input-group">
									...
									<div class="input text required">
										<input name="data[Reservation][from_date]" value=""
											class="form-control" title="From Date" required="required"
											onblur="clearRate();" type="text" id="ReservationFromDate" />
									</div>
								</div>
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1">Check
									...
									<div class="input text required">
										<input name="data[Reservation][to_date]" value=""
											class="form-control" title="To Date" required="required"
											onblur="clearRate();" type="text" id="ReservationToDate" />
									</div>
								</div>
							</div>
							...
							<div class="rooms">
								<div class="input-group roomplan-w">
									<span class="input-group-addon" id="basic-addon1">Room
										Type :</span> <select name="data[Reservation][room_plan_id]"
										required="required" class="form-control" title="Room Plan"
										onchange="clearRate();" id="ReservationRoomPlanId">
							...
							<div class="rooms">
								<div class="input-group roomplan-w">
									...
									<div class="input select required">
										<select name="data[Reservation][no_of_rooms]" id="no_of_rooms"
											class="form-control nos" required="required"
											onchange="find_rooms();">
							...
							<script>
								...
								function find_rooms() {
									...
									if (a > 0) {
										...
										while (min <= max) {
											text += '<div  class="rooms"><div class="input-group nos "><span class="input-group-addon right-arrow" id="basic-addon1" style="border:1px solid #333; width:70px;">Room &nbsp'
													+ min
													+ '</span></div><div class="input-group nos"><span class="input-group-addon smaller" id="basic-addon1" >Adult :</span><select name="info[room'
													+ min
													+ '][adult][]" onchange="childhide();" id="adult'
													+ min
													+ '"  class="form-control nos odoo "><option value="1">01</option><option value="2">02</option><option value="3">03</option>  </select></div><div class="input-group nos " id="child'+min+'"><span class="input-group-addon smaller jk" >Children :</span><select name="info[room'
													+ min
													+ '][child][]" class="form-control jk" onchange="clearRate();" id="child1'
													+ min
													+ '"><option value="0" selected>00</option><option value="1">01</option><option value="2">02</option>  </select></div></div>';
											$("#ol").html(text);
											min++;
										}
  ...
  <input type="radio" name="data[Reservation][single_double]" id="ReservationSingleDouble1" value="1" div="1">Double
					...
					<div class="row bottom-form">
						<div class="col-xs-12" style="padding-left: 20px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-6">
									<div class="input email required">
										<input name="data[Reservation][email]" class="form-control"
											title="Email ID" required="required"
											placeholder="name@something.com"
											pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" maxlength="200"
											type="email" id="ReservationEmail" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<label for="fname" class="col-sm-2 control-label">Telephone
									<span style="color: #F00">*</span>
								</label>
								<div class="col-sm-10 col-md-6">
									<div class="input tel">
										<input name="data[Reservation][phone]" class="form-control"
											title="telephone" maxlength="15" required="required"
											placeholder="0000000000" pattern="[0-9]{10,16}" type="tel"
											id="ReservationPhone" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-6">
									<div class="input text required">
										<input name="data[Reservation][city]" class="form-control"
											title="City" required="required" placeholder="City"
											maxlength="200" type="text" id="ReservationCity" />
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-6">
									<select name="data[Reservation][country]" required="required"
										class="form-control" title="Please select Country"
										id="ReservationCountry">
