<jsp:include page="header.jsp" />
  ...
  <legend style="font-size: 36px;">Attractions</legend>
 ...
 <table align="center" border="0" cellpadding="0" cellspacing="0" class="hidden-xs" width="100%">
	<tbody>
		<tr>
			<td align="center">
				<img alt="Kanaka Durga Temple" class="thumbnail img-responsive" src="user/img/durga.png" width="100%" height="300px" /></td>
		</tr>
	</tbody>
</table>
...
<p>
	...
	<div class="col-md-4">	
	<legend style="font-size: 36px;"> Tourist Places</legend>
	<img src="user/img/ucaves.jpg" alt='Undravelli Caves' style='float: right;' class="thumbnail img-responsive"><br>
	<img src="user/img/Amaravati-Temple.jpg" alt='Amaravati Temple' style='float: right;' class="thumbnail img-responsive">
	<img src="user/img/bisland.jpg" alt='Bhavani Island' style='float: right;' class="thumbnail img-responsive">
	<img src="user/img/durga.jpg" alt='Kanakadurga Temple' style='float: right;' class="thumbnail img-responsive">
	<img src="user/img/kfort.jpg" alt='Kondapalli Fort' style='float: right;' class="thumbnail img-responsive">
