...
<div class="container">		
        <div id="ninja-slider" style="float:left; width: 960px;">
            <div class="slider-inner">
                <ul>
                    <li><a class="ns-img" href="img/sroom.png"></a></li>
                    <li><a class="ns-img" href="img/droom1.png"></a></li>
                    <li><a class="ns-img" href="img/droom.png"></a></li>
                    <li><a class="ns-img" href="img/function.png"></a></li>
                    <li><a class="ns-img" href="img/restaurent.png"></a></li>
                    <li><a class="ns-img" href="img/bar.png"></a></li>
                    <li><a class="ns-img" href="img/hroom.png"></a></li>
                    <li><a class="ns-img" href="img/slide.png"></a></li>
                    <li><a class="ns-img" href="img/Room.png"></a></li>
                    <li><a class="ns-img" href="img/hroom1.png"></a></li>
                    <li><a class="ns-img" href="img/dining.png"></a></li>
                </ul>
        ...
        <div id="thumbnail-slider" style="height: 490px;">
            <div class="inner">
                <ul>
                    <li>
                        <a class="thumb" href="img/sroom.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/droom1.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/droom.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/function.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/restaurent.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/bar.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/hroom.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/slide.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/Room.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/hroom1.png"></a>
                    </li>
                    <li>
                        <a class="thumb" href="img/dining.png"></a>
                    </li>
                </ul>
            </div>
        </div>
