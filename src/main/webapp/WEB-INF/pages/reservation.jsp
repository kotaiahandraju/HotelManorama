...
<!-- 									<button style="margin: 0px 0px 0px 289px;" type="button" class="btn btn-success" onclick="checkDateWise();">Check Availability</button> -->
					...
					<div class="row bottom-form">
						<div class="col-xs-12" style="padding-left: 20px;">
							...
							<div class="form-group" style="display: none;" id="showValidateOtp">
								<div class="col-md-4">
									<div class="input text required">
										<input name="oneTimePassword" value="" class="form-control"  required="required" id="oneTimePassword" />
									</div>
									<div class="col-md-4">
			...
			function getAdults(){
				...
				function checkOTPValidate() {
					...
					$.fn.makeMultipartRequest('POST','validateOTP', false,
							formData, false, 'text', function(data) {
							var otpDate=JSON.parse(data);
								console.log(otpDate);
								if(otpDate.otp != null){
									$("#hideDiv").hide();
									$("#showValidateOtp").show();
									otp=otpDate.otp;
								}
				...
				$("#otpValidate").click(function(){
					if($('#oneTimePassword').val() == otp){
						alert("otp validate sucessfully");
						userDetails();
