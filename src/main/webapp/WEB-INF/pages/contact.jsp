...
<div class="container padding_0">
	<div
		...
		<div
			class="col-md-12 col-sm-12 col-xs-12 padding_0 text-cente-xs text-cente-sm innerLeft">
			...
			<p>
				<strong>Hotel Manorama</strong><br /> M.G. Road, Near Old Bus Stand Governorpet,
